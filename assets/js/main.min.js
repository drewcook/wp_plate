...
jQuery.noConflict(),jQuery(document).ready(function(a){$lvl_1_nav=a("ul.navbar-nav > li"),$lvl_2_nav=a("li.dropdown > ul.dropdown-menu > li"),$lvl_1_nav.hover(function(){a(this).hasClass("dropdown")&&a(this).children("ul.dropdown-menu").toggle()}),$lvl_2_nav.hover(function(){a(this).hasClass("dropdown")&&a(this).children("ul.dropdown-menu").toggle()}),window.innerWidth<768?a(".header-navbar").stick_in_parent():a("header#masthead").stick_in_parent(),a("#main .entry-content img").each(function(){a(this).addClass("img-responsive")}),a("input.search-field").val(""),$navbar_search=a(".header-navbar .search-form-wrapper"),$navbar_search_field=$navbar_search.find(".search-form input.search-field"),a("a.open-search").on("click",function(n){n.stopPropagation(),a("body").addClass("search-is-open"),$navbar_search_field.attr("placeholder",""),$navbar_search_field.focus()}),a("body").on("click",function(n){$parent=a(n.target).parent(),"search-form-wrapper"===n.target.id||$parent.is("label")||a("body").hasClass("search-is-open")&&a("body").removeClass("search-is-open")}),a('a[href^="#"]:not(.carousel-control)').on("click",function(n){n.preventDefault();var e=this.hash,r=a(e);a(window).scrollTop()>=0&&a("html, body").stop().animate({scrollTop:r.offset().top-50},1e3,"swing",function(){window.location.hash=e})}),a(".nav-links .nav-previous a, .nav-links .nav-next a").removeAttr("rel")});