...
jQuery.noConflict(),jQuery(document).ready(function(n){$lvl_1_nav=n("ul.navbar-nav > li"),$lvl_2_nav=n("li.dropdown > ul.dropdown-menu > li"),$lvl_1_nav.on("mouseenter",function(){n(this).hasClass("dropdown")&&n(this).children("ul.dropdown-menu").show()}),$lvl_1_nav.on("mouseleave",function(){n(this).hasClass("dropdown")&&n(this).children("ul.dropdown-menu").hide()}),$lvl_2_nav.on("mouseenter",function(){n(this).hasClass("dropdown")&&n(this).children("ul.dropdown-menu").show()}),$lvl_2_nav.on("mouseleave",function(){n(this).hasClass("dropdown")&&n(this).children("ul.dropdown-menu").hide()}),window.innerWidth<768?n(".header-nav").stick_in_parent():n("header#masthead").stick_in_parent(),n("#main .entry-content img").each(function(){n(this).addClass("img-responsive")}),n("input.search-field").val(""),$navbar_search=n(".header-navbar .search-form-wrapper"),$navbar_search_field=$navbar_search.find(".search-form input.search-field"),n("a.open-search").on("click",function(a){a.stopPropagation(),n("body").addClass("search-is-open"),$navbar_search_field.attr("placeholder",""),$navbar_search_field.focus()}),n("body").on("click",function(a){$parent=n(a.target).parent(),"search-form-wrapper"===a.target.id||$parent.is("label")||n("body").hasClass("search-is-open")&&n("body").removeClass("search-is-open")}),n('a[href^="#"]:not(.carousel-control)').on("click",function(a){a.preventDefault();var e=this.hash,o=n(e);n(window).scrollTop()>=0&&n("html, body").stop().animate({scrollTop:o.offset().top-50},1e3,"swing",function(){window.location.hash=e})}),n(".nav-links .nav-previous a, .nav-links .nav-next a").removeAttr("rel")});